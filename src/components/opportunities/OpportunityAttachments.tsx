...
const leadAttachments: Attachment[] = [
  {
    id: 101,
...
const opportunityAttachments: Attachment[] = [
  {
    id: 201,
    name: "Proposal_DatPhat_2024.pdf",
    size: "3.8 MB",
    type: "pdf",
    uploadedBy: "Nguyen Bao Ngoc",
    date: "06/01/2024",
    source: "opportunity",
  },
  {
...
export const OpportunityAttachments = () => {
      ...
      {attachments.length === 0 ? (
        ...
        <div className="space-y-2">
          {attachments.map(attachment => {
            ...
            const sourceInfo = attachment.source ? sourceLabels[attachment.source] : null;
