...
const defaultFields: OpportunityCustomField[] = [
  { id: "industry", label: "Ngành nghề", type: "text", required: false, order: 0 },
  { id: "company-size", label: "Quy mô công ty", type: "select", options: ["1-10", "11-50", "51-200", "201-500", "500+"], required: false, order: 1 },
  { id: "competitor", label: "Đối thủ cạnh tranh", type: "text", required: false, order: 2 },
];
